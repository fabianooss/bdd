...
public class BaseSteps extends BaseSelenium {
	...
	@Dado("informo o campo {string} com {string}")
	public void informo_o_campo_com(String campo, String valor) {
		WebElement e = waitForLoadXpath(String.format("//input[@id=(//label[contains(., '%s')]/@for)]", campo));
		e.sendKeys(valor);
	}
